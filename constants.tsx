...
export const DADOS_INFRACAO: Infracao[] = [
  ...
  },
  {
    ...
    codigo: "771-41",
    artigo: "Art. 244, XI",
    tipificacao: "Passageiro com capacete de segurança sem viseira ou óculos de proteção",
    medida: "Retenção do veículo",
    gravidade: Gravidade.MEDIA,
    observacoes: "Irregularidade sanada (art. 270, §1º, do CTB), Autuação e liberação imediata"
  },
  ...
  {
    descricao: "Transportar criança com menos de 10 anos de idade como passageiro excedente em motocicleta (exemplo:criança entre dois adultos)",
    codigo: "707-21",
    artigo: "Art. 244, V",
